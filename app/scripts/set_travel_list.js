function setTravelList(num) {
	...
	elem.forEach(function (trav) {
		...
		'<button style=\'margin-top: 20px; margin-bottom:20px\'class=\'btn btn-info span1\' type=\'button\' onclick=\'document.location="TravelReview.html?user='+num+'&trav='+i+'"\'> Take a look! </button></a>';
